...
FIND_PROCEDURES = {
    ...
    OLD_FILE_FIND: FindProcedure(OLD_FILE_FIND, oldFileFind, True, startFunction=oldFileFindStart, recommendMainFunction=oldFileFindRecommend, validatorFunction=minimumIntToInfinityOrMaxValidator, argBoundary=1),
